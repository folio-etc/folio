...
echo "#define LITERATA_10_FONT_ID ($(
ruby -rdigest -e 'puts [
  "./literata_10_regular.h",
  "./literata_10_bold.h",
  "./literata_10_bolditalic.h",
  "./literata_10_italic.h",
].map{|f| Digest::SHA256.hexdigest(File.read(f)).to_i(16) }.sum % (2 ** 32) - (2 ** 31)'
))"

echo "#define NOTOSERIF_5_FONT_ID ($(
ruby -rdigest -e 'puts [
  "./notoserif_5_regular.h",
  "./notoserif_5_bold.h",
  "./notoserif_5_bolditalic.h",
  "./notoserif_5_italic.h",
].map{|f| Digest::SHA256.hexdigest(File.read(f)).to_i(16) }.sum % (2 ** 32) - (2 ** 31)'
))"

echo "#define NOTOSERIF_6_FONT_ID ($(
ruby -rdigest -e 'puts [
  "./notoserif_6_regular.h",
  "./notoserif_6_bold.h",
  "./notoserif_6_bolditalic.h",
  "./notoserif_6_italic.h",
].map{|f| Digest::SHA256.hexdigest(File.read(f)).to_i(16) }.sum % (2 ** 32) - (2 ** 31)'
))"

echo "#define NOTOSERIF_8_FONT_ID ($(
ruby -rdigest -e 'puts [
  "./notoserif_8_regular.h",
  "./notoserif_8_bold.h",
  "./notoserif_8_bolditalic.h",
  "./notoserif_8_italic.h",
].map{|f| Digest::SHA256.hexdigest(File.read(f)).to_i(16) }.sum % (2 ** 32) - (2 ** 31)'
))"

echo "#define NOTOSERIF_10_FONT_ID ($(
ruby -rdigest -e 'puts [
  "./notoserif_10_regular.h",
  "./notoserif_10_bold.h",
  "./notoserif_10_bolditalic.h",
  "./notoserif_10_italic.h",
].map{|f| Digest::SHA256.hexdigest(File.read(f)).to_i(16) }.sum % (2 ** 32) - (2 ** 31)'
))"
...
for id in LITERATA_10 \
          NOTOSERIF_5 NOTOSERIF_6 NOTOSERIF_8 \
          NOTOSERIF_10 NOTOSERIF_12 NOTOSERIF_14 NOTOSERIF_16 NOTOSERIF_18 \
