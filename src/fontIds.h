...
#define LITERATA_10_FONT_ID (272309946)
#define NOTOSERIF_5_FONT_ID (-292184184)
#define NOTOSERIF_6_FONT_ID (-1715821579)
#define NOTOSERIF_8_FONT_ID (-2106280164)
#define NOTOSERIF_10_FONT_ID (1133242680)
...
static_assert(NOTOSERIF_5_FONT_ID != 0, "Font ID collision with sentinel");
